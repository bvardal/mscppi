...
//disableCheckBoxes();
document.getElementById("loadingGO").innerHTML = "Loading... complete.";
document.getElementById("loadingReactome").innerHTML = "Loading... complete.";
document.getElementById("loadingOMIM").innerHTML = "Loading... complete.";
